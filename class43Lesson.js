...
const div1 = document.querySelectorAll('div'); // получаем элементы
...
for (let i = 0; i < div1.length; i++) {
    div1[i].style.backgroundColor = 'blue';
} 
...
const testS1 = document.querySelectorAll('.test');
testS1[3].remove(); //удаляем элемент с 3им индексом.
...
const wrapper1 = document.querySelector('.wrapper'), //получаем wrapper из DOCUMENT.
      test1 = document.querySelectorAll('.test'); //получили test-ы из DOCUMENT.
